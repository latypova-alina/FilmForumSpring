...
import ru.itis.actors.service.ActorsService;
...
public class MainController {
	...
	public ModelAndView adminPage() {
		...
		model.addObject("message", "Admin page only!");
	...
	public ModelAndView listActors() {
		...
		model.addObject("listActors", this.actorService.listActors());
		model.setViewName("all-actors");
